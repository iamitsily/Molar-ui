...
public class controller_admin_asjtesMenu extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.view_admin_asjtes_menu);
        ...
        //Cast
        imageView = findViewById(R.id.admin_ajustesMenu_back);
        tvNombre = findViewById(R.id.admin_ajustesMenu_nombreUsuario);
        tvRol = findViewById(R.id.admin_ajustesMenu_rol);
        imageViewPerfil = findViewById(R.id.admin_ajustesMenu_Perfil);
        ajustesCuentaDatos = findViewById(R.id.admin_ajustesMenu_btnAjustesDatos);
        terminosCondiciones = findViewById(R.id.admin_ajustesMenu_ajustesPoliticas);
        cerrarSesion = findViewById(R.id.admin_ajustesMenu_cerrarSesion);
        ...
        terminosCondiciones.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent1 = new Intent(getApplicationContext(), controller_admin_terminoscondiciones.class);
        ...
        ajustesCuentaDatos.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(getApplicationContext(), controller_admin_ajustesDatos.class);
        ...
        imageView.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(getApplicationContext(), controller_admin_menuAdmin.class);
                intent.putExtra("matricula",matricula);
                intent.putExtra("nombre", nombre);
                intent.putExtra("rol", rol);
                intent.putExtra("sexo", sexo);
    ...
    public void onBackPressed() {
        Intent intent = new Intent(this, controller_admin_menuAdmin.class);
        intent.putExtra("matricula",matricula);
        intent.putExtra("nombre", nombre);
        intent.putExtra("rol", rol);
        intent.putExtra("sexo", sexo);
