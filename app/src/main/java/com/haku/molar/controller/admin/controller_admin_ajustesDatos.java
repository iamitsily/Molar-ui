...
public class controller_admin_ajustesDatos extends AppCompatActivity implements Callback_assistant_ajustesPaciente {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.view_admin_ajustes_datos);
        ...
        //Cast
        edt_telefono = findViewById(R.id.admin_ajusteDatos_numeroTelefono);
        edt_email = findViewById(R.id.admin_ajusteDatos_email);
        edt_passNueva = findViewById(R.id.admin_ajusteDatos_passwordNueva);
        edt_passconfirmed = findViewById(R.id.admin_ajusteDatos_passwordConfirmar);
        edt_passActual = findViewById(R.id.admin_ajusteDatos_passwordActual);
        btnGuardar = findViewById(R.id.admin_ajusteDatos_guardarbtn);
        imageViewPerfil = findViewById(R.id.admin_ajusteDatos_fotoperfil);
        ibCambiarPerfil = findViewById(R.id.admin_ajusteDatos_cambiarFotoPerfil);
        cdIconos = findViewById(R.id.admin_ajusteDatos_cv);
        ivCerrarCV = findViewById(R.id.admin_ajusteDatos_cerrarcv);
        hombre2 = findViewById(R.id.admin_ajusteDatos_ivHombreDos);
        hombre3 = findViewById(R.id.admin_ajusteDatos_ivHombreTres);
        hombre4 = findViewById(R.id.admin_ajusteDatos_ivHombreCuatro);
        hombre5 = findViewById(R.id.admin_ajusteDatos_ivHombreCinco);
        mujer2 = findViewById(R.id.admin_ajusteDatos_ivMujerDos);
        mujer3 = findViewById(R.id.admin_ajusteDatos_ivMujerTres);
        mujer4 = findViewById(R.id.admin_ajusteDatos_ivMujerCuatro);
        mujer5 = findViewById(R.id.admin_ajusteDatos_ivMujerCinco);
