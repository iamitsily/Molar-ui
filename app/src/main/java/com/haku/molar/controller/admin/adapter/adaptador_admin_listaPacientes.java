...
public class adaptador_admin_listaPacientes extends RecyclerView.Adapter<adaptador_admin_listaPacientes.ViewHolder>{
    ArrayList<model_Admin> model_empleados = new ArrayList<>();
    Context context;
    private ItemClickListener itemClickListener;

    public adaptador_admin_listaPacientes(ArrayList<model_Admin> model_empleados, Context context, ItemClickListener itemClickListener) {
    ...
    @NonNull
    @Override
    public adaptador_admin_listaPacientes.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.item_assistant_buscarpacientelista,parent,false);
        return new adaptador_admin_listaPacientes.ViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull adaptador_admin_listaPacientes.ViewHolder holder, int position) {
        ...
        holder.matricula.setText(String.valueOf(model_empleados.get(position).getMatricula())+" | Paciente");
