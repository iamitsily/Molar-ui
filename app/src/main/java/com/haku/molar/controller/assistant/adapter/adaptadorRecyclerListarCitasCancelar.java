...
public class adaptadorRecyclerListarCitasCancelar extends RecyclerView.Adapter<adaptadorRecyclerListarCitasCancelar.ViewHolder>{
    ArrayList<model_cita> model_citas = new ArrayList<>();
    private ItemClickListener itemClickListener;
    Context context;
    public adaptadorRecyclerListarCitasCancelar(ArrayList<model_cita> model_citas, Context context, ItemClickListener itemClickListener) {
    ...
    @NonNull
    @Override
    public adaptadorRecyclerListarCitasCancelar.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.item_patient_listacitasactivas,parent,false);
        return new adaptadorRecyclerListarCitasCancelar.ViewHolder(view);
    }
